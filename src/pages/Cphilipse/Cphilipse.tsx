    ...
    <View style={styles.container}>
      ...
      <View style={styles.bodyContainer}>
        <Text style={styles.body}>
          Hello! My name is Clemens and here I'm gonna tell some things about me
          and this app.{'\n'}
        </Text>
        ...
        <Text style={styles.body}>
          ...
          Science at the university of Leiden. My ultimate dream and goal is to
          become a digital investigator at Interpol in Lyon.
          {'\n'}
        </Text>
